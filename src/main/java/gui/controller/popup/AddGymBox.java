...
public class AddGymBox extends JDialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            String url = "http://localhost:8084/trainings/gym/add";
            ...
            GymCreateDto gymCreateDto = new GymCreateDto();
            gymCreateDto.setName(name.getText());
            gymCreateDto.setDescription(description.getText());

            // Konvertujte objekat u JSON string
            Gson gson = new Gson();
            String postData = gson.toJson(gymCreateDto);
